...
<body>
  ...
  <main class="gov-page">
    ...
    <div class="politica-card">
        ...
        <a href="<?=BASE_URL?>assets/docs/privacidade.pdf" target="_blank" class="btn-acessar-pdf">ACESSAR</a>
    </div>
    ...
    <div class="politica-card">
        ...
        <a href="<?=BASE_URL?>assets/docs/governanca-protecao-dados.pdf" target="_blank" class="btn-acessar-pdf">ACESSAR</a>
    </div>
    ...
    <div class="politica-card">
        ...
        <a href="<?=BASE_URL?>assets/docs/etica-e-conduta.pdf" target="_blank" class="btn-acessar-pdf">ACESSAR</a>
    </div>
    ...
    <div class="politica-card">
        ...
        <a href="<?=BASE_URL?>assets/docs/combate-corrupcao.pdf" target="_blank" class="btn-acessar-pdf">ACESSAR</a>
    </div>
    ...
    <div class="politica-card">
        ...
        <a href="<?=BASE_URL?>assets/docs/combate-assedio.pdf" target="_blank" class="btn-acessar-pdf">ACESSAR</a>
    </div>
    ...
    <div class="politica-card">
        ...
        <a href="<?=BASE_URL?>assets/docs/sustentabilidade.pdf" target="_blank" class="btn-acessar-pdf">ACESSAR</a>
    </div>
